...
CHANGE_ME_GUEST_TOKEN_JWT_SECRET = "test-guest-secret-change-me-please"  # noqa: S105
CHANGE_ME_GLOBAL_ASYNC_QUERIES_JWT_SECRET = "test-secret-change-me-to-a-better-one"  # noqa: S105
